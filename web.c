...
"  // see them in JSON for debugging, but we don't update aggregate\n"
"  // views with bytes we know are mangled.\n"
"  const crcFail = (p.payload_crc_ok === false);\n"
"  if (crcFail) return; /* skip topology / nodes / channels accumulation */\n"
